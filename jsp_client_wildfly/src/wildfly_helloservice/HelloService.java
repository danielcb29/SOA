 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://wildfly_helloservice/", wsdlLocation = "http://localhost:8080/wildfly_helloservice/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://wildfly_helloservice/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/wildfly_helloservice/Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://wildfly_helloservice/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wildfly_helloservice/", "HelloPort"), Hello.class, features);
    }
