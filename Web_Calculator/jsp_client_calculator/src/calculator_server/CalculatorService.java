 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calculator_server/", wsdlLocation = "http://localhost:8080/calculator_server/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calculator_server/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/calculator_server/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calculator_server/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator_server/", "CalculatorPort"), Calculator.class, features);
    }
